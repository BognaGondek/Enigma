...
int* Rotor::findPerm()
{
    int* newPermAlphabet = new int[length];
    for (int i = 0; i < length; i++)
    {
        for (int j = 0; j < length; j++)
        {
            if (basicAlphabet[i] == characteristicAlphabet[j])
            {
                newPermAlphabet[i] = j;
            }
        }
    }
    return newPermAlphabet;
}
...
Rotor::Rotor(const Rotor& orig)
{
    ...
    permuAlphabet = new int[length];
    copy(permuAlphabet, orig.permuAlphabet, length);
...
Rotor& Rotor::operator=(const Rotor& right)
{
    ...
    std::swap(permuAlphabet, rotor.permuAlphabet);
...
Rotor& Rotor::operator=(Rotor&& right)
{
    ...
    std::swap(permuAlphabet, right.permuAlphabet);
